...
create table itens (data timestamp(6), id bigint generated by default as identity, usuario_id bigint, descricao varchar(255), endereco varchar(255), nome varchar(255), status varchar(255) check (status in ('MATCHING','EM_DEVOLUCAO','RECUPERADO')), tipo varchar(255) check (tipo in ('PERDIDO','ACHADO')), primary key (id));
