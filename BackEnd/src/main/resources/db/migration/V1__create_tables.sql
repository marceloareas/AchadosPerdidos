...
create table matchs (confirmacao_achado boolean not null, confirmacao_perdido boolean not null, id bigint generated by default as identity, item_achado_id bigint, item_perdido_id bigint, primary key (id));
